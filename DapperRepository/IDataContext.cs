...
namespace DapperRepository
{
    public interface IDataContext
    {
        ...
        void Execute(string sqlCommand, object parameters = null, IDbTransaction transaction = null);
        IDataReader ExecuteReader(string sqlCommand, object parameters = null, IDbTransaction transaction = null);
        T ExecuteScalar<T>(string sqlCommand, object parameters = null, IDbTransaction transaction = null) where T : BaseEntity;
